...
// D = late nights daily.
const AV = {
  A: [{ day: 2, start: "18:00", end: "21:00" }, { day: 4, start: "18:00", end: "21:00" }],
  B: [{ day: 1, start: "18:00", end: "21:00" }, { day: 3, start: "18:00", end: "21:00" }],
  C: [{ day: 6, start: "09:00", end: "13:00" }, { day: 0, start: "09:00", end: "13:00" }],
  D: [2, 3, 4, 5].map((day) => ({ day, start: "21:30", end: "23:30" })),
  AB: [
    { day: 2, start: "18:00", end: "21:00" }, { day: 4, start: "18:00", end: "21:00" },
...
const P = [
  ...
  ["ananya", "Ananya Rao", "AIML", 4, 5, 3, "C", ["machine-learning", 0.9, 1], ["data-engineering", 0.7, 1]],
  ...
  ["anika", "Anika Singh", "AIML", 3, 4, 4, "B", ["machine-learning", 0.75, 1], ["data-engineering", 0.6, 1]],
  ["manav", "Manav Shah", "AIML", 2, 2, 3, "D", ["machine-learning", 0.55, 0]],
  ["leela", "Leela Chandran", "Design", 2, 2, 4, "B", ["figma", 0.65, 0], ["video-editing", 0.6, 1]],
  ["omar", "Omar Sheikh", "Mech", 3, 3, 3, "C", ["unity", 0.7, 1], ["video-editing", 0.5, 0]],
  ["ritika", "Ritika Bose", "Biotech", 4, 4, 4, "B", ["data-engineering", 0.7, 1], ["content-writing", 0.7, 1]],
  ["arnav", "Arnav Kapoor", "CSE", 3, 3, 3, "B", ["cybersecurity", 0.8, 1], ["backend", 0.55, 0]],
  ["sara", "Sara Thomas", "IT", 2, 2, 5, "A", ["cybersecurity", 0.55, 0], ["content-writing", 0.4, 0]],
  ...
  ["divya", "Divya Anand", "AIML", 3, 3, 4, "A", ["data-engineering", 0.75, 1], ["machine-learning", 0.5, 0]],
  ["harsh", "Harsh Vardhan", "Civil", 2, 2, 3, "C", ["content-writing", 0.6, 0], ["pitching", 0.45, 0]],
...
const profiles = P.map((row, i) => {
  ...
  return {
    id: pid(i + 1), handle, name, dept, year,
    bio: null,
    experience_level: exp, commitment_level: commit,
    availability_windows: AV[av],
    is_seed: true,
    skills: skills.map(([skill, proficiency, proved]) => ({
      skill, proficiency, proof_url: proved ? gh(handle) : null,
    })),
  };
});
...
const events = [
  {
    id: eid(1), source: "organiser", external_url: "https://sih.gov.in",
    title: "Smart India Hackathon 2026", host: "MoE Innovation Cell",
    mode: "hybrid", location: "Nationwide",
    starts_at: "2026-09-18T04:30:00Z", ends_at: "2026-09-19T14:30:00Z",
    deadline_at: "2026-09-10T18:29:00Z", tags: ["hackathon", "national"],
...
const projects = [
  {
    id: FLAGSHIP, owner: pid(1), event_id: eid(1),
  ...
  {
    id: jid(2), owner: pid(19), event_id: eid(2),
  ...
  {
    id: jid(3), owner: pid(26), event_id: null,
  ...
  {
    id: jid(4), owner: pid(17), event_id: eid(3),
...
const staticSeed = {
  ...
  projects: projects.map((p) => ({
    id: p.id, owner_profile_id: p.owner, community_id: COMMUNITY, event_id: p.event_id,
    title: p.title, description: p.description, deadline: p.deadline, is_seed: true,
    requirements: p.requirements.map(([skill, role_label, weight, min_proficiency]) => ({
      id: rid(++reqCount), skill, role_label, weight, min_proficiency,
    })),
