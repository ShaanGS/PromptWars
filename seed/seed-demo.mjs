...
const events = ingested.map((e, i) => {
  ...
  return {
    ...
    title: e.title,
    title_norm: e.title.toLowerCase().replace(/[^a-z0-9 ]/g, ' ').replace(/\s+/g, ' ').trim(),
    description: null,
...
const LOOKING = ['Hackathon Team', 'Research Project', 'Startup / Idea', 'Side Project', 'Collab & Learn']
...
const P = [
  ['aarav', 'Aarav Menon', 'CSE', 3, 4, 5, 'A', 0, ['machine-learning', 0.7, 1], ['backend', 0.4, 0]],
  ...
  ['kabir', 'Kabir Bedi', 'MBA', 2, 3, 4, 'A', 2, ['pitching', 0.8, 1], ['content-writing', 0.6, 0]],
  ['ananya', 'Ananya Rao', 'AIML', 4, 5, 3, 'C', 1, ['machine-learning', 0.9, 1], ['data-engineering', 0.7, 1]],
  ...
  ['priya', 'Priya Menon', 'ECE', 2, 2, 3, 'C', 4, ['embedded', 0.6, 0], ['machine-learning', 0.4, 0]],
  ['sanjay', 'Sanjay Rathi', 'CSE', 4, 4, 3, 'B', 2, ['backend', 0.85, 1], ['devops', 0.7, 1]],
  ['kavya', 'Kavya Nambiar', 'IT', 3, 3, 4, 'A', 0, ['backend', 0.7, 1], ['data-engineering', 0.5, 0]],
  ['rahul', 'Rahul Joshi', 'CSE', 2, 2, 4, 'B', 3, ['backend', 0.6, 0]],
  ['anika', 'Anika Singh', 'AIML', 3, 4, 4, 'B', 1, ['machine-learning', 0.75, 1], ['data-engineering', 0.6, 1]],
  ['manav', 'Manav Shah', 'AIML', 2, 2, 3, 'D', 4, ['machine-learning', 0.55, 0]],
  ['leela', 'Leela Chandran', 'Design', 2, 2, 4, 'B', 3, ['figma', 0.65, 0], ['video-editing', 0.6, 1]],
  ['omar', 'Omar Sheikh', 'Mech', 3, 3, 3, 'C', 3, ['unity', 0.7, 1], ['video-editing', 0.5, 0]],
  ['ritika', 'Ritika Bose', 'Biotech', 4, 4, 4, 'B', 1, ['data-engineering', 0.7, 1], ['content-writing', 0.7, 1]],
  ['arnav', 'Arnav Kapoor', 'CSE', 3, 3, 3, 'B', 0, ['cybersecurity', 0.8, 1], ['backend', 0.55, 0]],
  ['sara', 'Sara Thomas', 'IT', 2, 2, 5, 'A', 4, ['cybersecurity', 0.55, 0], ['content-writing', 0.4, 0]],
  ...
  ['karthik', 'Karthik Subramanian', 'CSE', 4, 5, 2, 'C', 2, ['backend', 0.9, 1], ['devops', 0.8, 1]],
  ['divya', 'Divya Anand', 'AIML', 3, 3, 4, 'A', 1, ['data-engineering', 0.75, 1], ['machine-learning', 0.5, 0]],
  ['harsh', 'Harsh Vardhan', 'Civil', 2, 2, 3, 'C', 4, ['content-writing', 0.6, 0], ['pitching', 0.45, 0]],
  ...
  ['mira', 'Mira Sethu', 'Biotech', 2, 2, 4, 'A', 4, ['content-writing', 0.65, 1], ['figma', 0.4, 0]],
